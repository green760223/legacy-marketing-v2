...
export function Feature() {
  ...
  return (
    <div className='relative py-40 z-20 max-w-7xl mx-auto'>
      <div className='px-8'>
        <h4 className='text-3xl lg:text-4xl lg:leading-tight max-w-5xl mx-auto text-center tracking-widest font-medium text-black dark:text-white '>
          OUR EXPERTISE
        </h4>
        ...
        <p className='text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300 tracking-widest'>
          Legacy Marketing, Creating Your Legacy
        </p>
      </div>
